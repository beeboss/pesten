...
/* ----- Global Variables ---------------------------------------- */
	...
	var inky, blinky, clyde, pinky, lizzy;
	...
	function Game() {
		...
		this.init = function (state) {
			...
			if (pinky === null || pinky === undefined) {
                ...
                lizzy = new Ghost("lizzy",11,5,'img/lizzy.svg',13,2);
			}
			else {
	...
	// Direction Objects
	var up = new Direction("up",1.25,0.75,0,-1);		// UP
	var left = new Direction("left",1.25,0.75,-1,0);	// LEFT
	var down = new Direction("down",0.25,1.75,0,1);		// DOWN
